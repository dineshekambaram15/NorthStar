...
variable "eks_cluster_subnet_ids" {
  type = list(string)
  default = ["subnet-02314f395c899154a", "subnet-09b10a074b1724853"]
...
variable "private_subnet_ids" {
  type = list(string)
  default = ["subnet-02314f395c899154a"]
  description = "List of private subnet IDs."
}

variable "public_subnet_ids" {
  type = list(string)
  default = ["subnet-09b10a074b1724853"]
